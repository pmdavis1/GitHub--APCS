    ...
    public static void main (String[] args) {
        ...
        case 's':
            ...
            c = scan.nextDouble();
              ...
              //sides have to be greater than zero
            if ((c > a + b) || (b > a + c) || (a > b + c) || ((a <= 0) || (b <= 0) || (c <= 0)))
                System.out.println("No possible triangle");
            
            // if all sides equal it is equilateral
            else if ((a==b) && (b==c))
                System.out.println("Equilateral");
            
            //if 2 sides equal it is isosceles
            else if ((a==b) || (b==c) || (a==c))
                System.out.println("Isosceles");
            
            // if it obeys the pythagorean theorem it is right
        ...
        case 'a':
            ...
            b = scan.nextDouble();
            c = scan.nextDouble();
               //angles have to be greater than zero
